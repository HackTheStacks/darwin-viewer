...
var _imageModel = require('./image-model.js');
...
angular.module('app').controller('AppCtrl', ['AppService', AppCtrl]);
'use strict';
...
angular.module('app').factory('AppService', ['$http', AppService]);
'use strict';
...
angular.module('app').directive('pan', pan);
'use strict';
...
angular.module('app').directive('zoomToolbar', zoomToolbar);
'use strict';
